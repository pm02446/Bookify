...
<html>
	...
	<body class="is-preload">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1><a href="welcome.php">Apartment Portal</a> Payment History</h1>
					<nav id="nav">
						<ul>
			...
			<!-- Main -->
				<section id="main" class="container medium">
					...
					<div class="box">
						<?php
						$q = 'Select* FROM payments WHERE paid = "true" AND payID=all(SELECT payID FROM rentPay WHERE renterUser =?);';
