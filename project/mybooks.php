            ...
            <div class="inner">
                ...
                <section class="box">
                    <?php
                            ...
                            $q = 'SELECT title, author, description, image FROM book as b, users_book as r 
                ...
                <form action="delet.php" method="POST">
                        <div><br><input type="text" name="title" placeholder="Title of Book"><br><br>
                            <input type="submit" name="tb" value="Remove book"/>
